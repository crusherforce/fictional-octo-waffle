...
public class SuffixArrayMed extends SuffixArray {
    ...
    SuffixArrayMed(String text) {
        super(toIntArray(text));
    }

    SuffixArrayMed(int[] text) {
        super(text);
    }
    ...
    protected void construct() {
        ...
        // Maintain suffix ranks in both a matrix with two rows containing
        // the current and last rank information as well as some sortable rank obejcts
